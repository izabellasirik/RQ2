...
export const RISK_PROFILE_GROUPS: RiskFieldGroup[] = [
  {
    ...
    fields: [
      { key: 'namedInsured', label: 'Named Insured', type: 'text', section: 'business', hint: 'The legal applicant for coverage — not automatically the same as an owner, driver, or contact.' },
      ...
      { key: 'ownerName', label: 'Owner Name', type: 'text', section: 'business', hint: 'The individual owner, when a document states one — distinct from Named Insured and from any driver.' },
      ...
      { key: 'mailingAddress', label: 'Mailing Address', type: 'textarea', section: 'business', hint: 'Only if different from the address above.' },
      { key: 'phone', label: 'Phone', type: 'text', section: 'business' },
      { key: 'email', label: 'Email', type: 'text', section: 'business' },
